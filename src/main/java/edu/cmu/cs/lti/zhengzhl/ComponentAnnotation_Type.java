...
public class ComponentAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.lti.zhengzhl.ComponentAnnotation");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "edu.cmu.cs.lti.zhengzhl.ComponentAnnotation");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.cmu.cs.lti.zhengzhl.ComponentAnnotation");
